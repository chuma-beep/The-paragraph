...
//       .from('drafts')
//       .select('*, id, title, content, updates_at, user_id, cover_image_url')
//       .eq('id', id)
//       .single();
...
//            if (deleteError){
//             console.error('Error deleting darft:', deleteError.message);
//             toast.error('Draft published, but failed to delete the draft');
//            }else{
//             setDrafts(draft.filter((draft => draft.id != id));
//            }
          
//            toast.success('Post pub;ished successfully!');
//         } catch (error){
//             console.error('Error publishing draft:', error);
//             toast.error('Error Publisng draft');
//         }finally{
//           setLoading(false);
//         }
//    };
...
//   useEffect(() => {
//     if (drafts && drafts.content) {
//       convertMarkdownToBlocks(drafts.content);
//     }
...
//                 variant="outline"
//                 size="sm"
//                 // onClick={() => handlePublish(drafts.id)}
