...
import GithubAuthenticate from "@/app/login/github/GithubAuth";
import GoogleAuthenticate from "@/app/login/google/GoogleAuthButton"
...
export default function Signup({ searchParams }: { searchParams: Message }) {
  ...
  return (
    <div className="flex flex-col flex-1 h-screen p-40 w-full justify-center items-center">
     <Link
        href="/"
      ...
      <div className="flex flex-col w-full lg:flex-row items-center lg:space-x-12">
        <Image
          src="/Signup.jpg"
          alt="Logo"
          width={600}
