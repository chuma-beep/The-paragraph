...
//     if (!isValidUuid(id)) { // Validate UUID format
...
//   // Fetch post data when 'id' changes and is valid
//   useEffect(() => {
//     console.log("Post ID:", id); // Debugging line
//     if (id && isValidUuid(id)) {
//       fetchPost();
//     } else if (id) { // If 'id' exists but is invalid
