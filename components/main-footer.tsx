...
export default function MainFooter() {
  return (
    <footer className="bg-muted py-2 md:py-4 rounded-full">
      <div className="container w-full flex flex-row items-center gap-4 md:flex-row md:justify-between">
          <DeployButton />
        <p className="text-sm text-muted-foreground">&copy; 2024 TheParagraph Inc. All rights reserved.</p>
